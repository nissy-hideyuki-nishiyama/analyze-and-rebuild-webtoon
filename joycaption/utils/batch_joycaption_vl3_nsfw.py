...
#     "Qwen/Qwen3-VL-8B-Instruct"   # 公式の processor を使う
# )

# model = AutoModelForImageTextToText.from_pretrained(
#     "/mnt/ssd-data/common/huggingface/gavinmroy/Qwen3-VL-8B-NSFW-Caption-V4.5-affine-4bit",
...
class QwenVLCaptionPipeline:
    def __init__(
        ...
        model_dir: str = "/mnt/ssd-data/common/huggingface/gavinmroy/Qwen3-VL-8B-NSFW-Caption-V4.5-affine-4bit",
        # プロセッサ用ベースモデル（使用しているベースモデルの公式リポジトリ名）
        processor_base: str = "Qwen/Qwen3-VL-8B-Instruct",
        device: str = "cuda",
    ):
        self.device = device
        ...
        self.model = Qwen3VLForConditionalGeneration.from_pretrained(
            model_dir,
            # quantization_config=bnb_config, # load_in_4bit=True の代わりにこちらを指定
            torch_dtype=torch.bfloat16,
            device_map="auto",
            # load_in_4bit=True,
            trust_remote_code=True,
